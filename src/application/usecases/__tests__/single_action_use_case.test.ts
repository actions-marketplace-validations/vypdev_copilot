...
describe('SingleActionUseCase', () => {
  ...
  it('returns empty results when not a valid single action', async () => {
    const useCase = new SingleActionUseCase({ invoke: jest.fn().mockResolvedValue([]) } as any, {} as any, { invoke: mockCheckProgressInvoke } as any, {} as any, {} as any, {} as any, {} as any, {} as any);
