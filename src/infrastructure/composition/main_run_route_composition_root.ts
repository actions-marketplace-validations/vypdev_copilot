...
import { createBranchComparisonClient, createBranchMergeClient } from './github_branch_client_factory';
...
import { createIssueClosureRepository, createIssueNotificationRepository } from './issue_interaction_composition_root';
...
export function createIssueCommentUseCaseCompositionRoot(): IssueCommentUseCase {
    ...
    return new IssueCommentUseCase(
        ...
        new DetectBugbotFixIntentUseCase(bugbot.context.pullRequest, findings, bugbot.context),
        new ThinkUseCase(createIssueContentCompositionRoot(), createIssueNotificationRepository(), findings),
...
export function createMainRunRouteCompositionRoot(
    ...
    return {
        ...
        issue: async (execution) => createIssueUseCaseCompositionRoot().invoke(execution),
        'pull-request-review-comment': async (execution) => createPullRequestReviewCommentUseCaseCompositionRoot().invoke(execution),
        'pull-request': async (execution) => createPullRequestUseCaseCompositionRoot().invoke(execution),
