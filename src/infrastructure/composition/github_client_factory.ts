...
export class GithubClientFactory {
    ...
    createGraphqlTransportClient(): OctokitGraphqlTransportClientAdapter { return new OctokitGraphqlTransportClientAdapter(); }
