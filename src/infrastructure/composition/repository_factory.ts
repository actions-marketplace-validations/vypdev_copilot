...
export class RepositoryFactory {
    ...
    createIssueRepository(): IssueRepository {
        return new IssueRepository(this.createIssueContentRepository(), this.createIssueLifecycleRepository());
    }
