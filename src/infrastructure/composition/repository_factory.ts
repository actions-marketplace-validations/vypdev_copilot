...
import { OctokitClientAdapter, OctokitGraphqlClientAdapter, OctokitIssueLifecycleClientAdapter, OctokitOrganizationClientAdapter, OctokitPullRequestChangesClientAdapter, OctokitPullRequestLifecycleClientAdapter, OctokitPullRequestReviewClientAdapter, OctokitWorkflowClientAdapter } from "../github/octokit_client";
...
export class RepositoryFactory {
    ...
    createIssueRepository(): IssueRepository {
        return new IssueRepository(this.createIssueLifecycleRepository());
    }
