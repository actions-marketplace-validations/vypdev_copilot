...
1. **Node.js 24** – Use `nvm use 24` if you have nvm.
...
| Connection refused to OpenCode | Start the OpenCode server (`pnpm dlx --yes opencode-ai serve`) before running the CLI. |
